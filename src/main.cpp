...
uint256 hashGenesisBlock("0xfdeb52750e9197a97cef90d8cd6cc4bf7e560b8616caf5ea35bf72da2ef44bed");
...
const string strMessageMagic = "Astato Signed Message:\n";
...
static const int64 nTargetSpacing = 20; // Astato: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal astato miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Astato", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xfdeb52750e9197a97cef90d8cd6cc4bf7e560b8616caf5ea35bf72da2ef44bed");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2017-Aug-21 18:45:05 UTC";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1503347523; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 415691;

        if (fTestNet)
        {
            block.nTime    = 1503347523;
            block.nNonce   = 415691;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x8d39ed267d2ae2462f68a35bd1a53b7c64f32bd4aef12faffa084575c81a9b43"));
        ...
        block.print();
        //hashGenesisBlock  = uint256("0xeedddb6a3408b0b6ebd0721fe6f15c31bd180c02f4f29fad0de8aae883109eeb"); //gambiarra
